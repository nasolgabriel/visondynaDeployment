...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] \
   ...
   text-slate-400 hover:bg-lime-500/10 hover:text-lime-500 active:bg-lime-500/10 active:text-lime-500 \
   data-[active=true]:bg-lime-500/10 data-[active=true]:font-medium data-[active=true]:text-lime-500 \
   data-[state=open]:hover:bg-lime-500/10 data-[state=open]:hover:text-lime-500",
  {
    variants: {
      variant: {
        default: "hover:bg-lime-500/10 hover:text-lime-500",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] \
           hover:bg-lime-500/10 hover:text-lime-500 hover:shadow-[0_0_0_1px_theme(colors.lime.500_/0.2)]",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
